...
breadcrumb = [
    { title = "Part 0: Introduction", page = "learn/stark-anatomy" },
    { title = "Part 1: STARK Overview", page = "learn/stark-anatomy/overview" },
    { title = "Part 2: Basic tools", page = "learn/stark-anatomy/basic-tools" },
    { title = "Part 3: FRI", page = "learn/stark-anatomy/fri" },
    { title = "Part 4: The Stark Polynomial IOP", page = "learn/stark-anatomy/stark" },
    { title = "Part 5: A Rescue-Prime STARK", page = "learn/stark-anatomy/rescue-prime" },
    { title = "Part 6: Speeding Things Up", page = "learn/stark-anatomy/faster" },
]
+++
